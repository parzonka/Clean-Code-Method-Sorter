...
public final class CompilationUnitSorter {
     ...
     * comparator to preserve the relative positions of certain kinds of body
     * declarations when required.
     * <p>
     * All body declarations passed to the comparator's <code>compare</code>
     * method by <code>CompilationUnitSorter.sort</code> carry an Integer-valued
     * property. The body declaration with the lower value comes before the one
     * with the higher value. The exact numeric value of these properties is
     * unspecified.
     * </p>
     * <p>
     * Example usage:
     ...
     * specified AST level. The caller is responsible for arranging in advance
     * that the given compilation unit is a working copy, and for saving the
     * changes afterwards.
     * <p>
     * <b>Note:</b> Reordering the members within a type declaration might be
     * more than a cosmetic change and could have potentially serious
     ...
     * {@link org.eclipse.jdt.core.dom.ASTParser#newParser(int)}. Clients will
     * generally specify AST.JLS3 since that will cover all constructs found in
     * Java 1.0, 1.1, 1.2, 1.3, 1.4, and 1.5 source code. The comparator is
     * called on body declarations of nested classes, including anonymous and
     * local classes, but always at the same level. Clients need to provide a
     * comparator implementation (there is no standard comparator). The
     * <code>RELATIVE_ORDER</code> property attached to these AST nodes afforts
     ...
     *            the comparator capable of ordering
     *            <code>BodyDeclaration</code>s; this comparator is passed AST
     *            nodes from an AST of the specified AST level
     * @param options
     *            bitwise-or of option flags; <code>0</code> for default
     *            behavior (reserved for future growth)
     * @param monitor
     ...
     * @exception IllegalArgumentException
     *                if the given compilation unit is null or if the given
     *                comparator is null, or if <code>level</code> is not one of
     ...
     * local classes, but always at the same level. Clients need to provide a
     * comparator implementation (there is no standard comparator). The
     * <code>RELATIVE_ORDER</code> property attached to these AST nodes affords
     * the comparator a way to preserve the original relative order.
     * </p>
     * <p>
     * The body declarations passed as parameters to the comparator always carry
     ...
     *            behavior (reserved for future growth)
     * @param group
     *            the text edit group to use when generating text edits, or
     *            <code>null</code>
     * @param monitor
     *            the progress monitor to notify, or <code>null</code> if none
